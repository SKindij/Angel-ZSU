...
```sql
  ...
  VALUES
    ...
    (7503, true, 21, 'На пікап для 13 ОБ НГУ', 'Бійці  Бригади ведуть важкі бої  в Серебрянському лісі. Їм вкрай необхідне авто для підвозу бк, продовольства та вивозу поранених воїнів.', 245000, 'https://www.youtube.com/watch?v=cyWmQuznz94', 'https://send.monobank.ua/jar/3RWiy1PPFb'),
